function changeRankKeyword(){
    ...
    document.getElementById("4thRankText").innerHTML=document.getElementById("inputText").value;
    document.getElementById("5thRankText").innerHTML=document.getElementById("inputText").value;
  }
